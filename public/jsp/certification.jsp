...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>front/public/css/qualifyManagement.css">
    ...
    <div class="content">
        <form class="newAdd-form" method="post">
            <div class="content-item">
                ...
                <input class="easyui-validatebox" type="text" data-options="required:true,validType:'allName'" placeholder="请输入证件名称" maxlength="50" />
            </div>
            <div class="content-item">
                <label for="station-region">*证件编号:</label>
                <input class="easyui-validatebox" type="text" data-options="required:true,validType:'englishNumber'" placeholder="请输入证件编号" maxlength="30" />
            </div>
            <div class="content-item">
                <label for="station-address">*发证单位:</label>
                <input class="easyui-validatebox" type="text" data-options="required:true,validType:'allName'" placeholder="请输入发证单位" maxlength="50" />
            </div>
            <div class="content-item">
            ...
            <div class="content-item">
                <label for="station-address">*所属人:</label>
                <input class="easyui-validatebox" type="text" data-options="required:true,validType:'name'" placeholder="请输入所属人" maxlength="30" />
            </div>
        </form>
    </div>
    <div class="footer">
...
<script src="<%=basePath%>front/public/js/qualifyManagement.js"></script>
</body>
</html>