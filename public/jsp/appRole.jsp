...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>front/public/css/appRole.css">
...
<body>
                ...
                <table class="treetable power" id="treeTable3">
                    ...
                    <tbody>
                        <tr data-tt-id="1">
                            <td>基本信息</td>
                            <td>
                                <a class="checkbox-wrapper checkbox-wrapper-checked">
                                    <i></i>
                                    <input type="checkbox" name="" id="" class="check-row" checked>
                                </a>
                            </td>
    ...
    <div class="popup edit-role-name-popup">
        ...
        <div class="content">
            <form action="updateRoleName" id="editRoleForm" method="post">
                <div class="content-item">
                    <label>角色名*</label>
    ...
    <script src="<%=basePath%>front/public/js/appRole.js"></script>
</body>
