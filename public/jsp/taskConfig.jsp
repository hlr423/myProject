...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>front/public/css/taskConfig.css">
...
<body>
    <div class="body-wrapper">
        <div class="search-wrapper">
            <select id="type" name="type" class="easyui-combotrees cbt">
	            <option value="" selected>请选择分属类型</option>
            	<option value="1">厂站</option>
            	<option value="2">设备</option>
            	<option value="3">部件</option>
            	<option value="4">车辆</option>
            </select>
            <input type="text" name="keyWord" id="keyWord"  placeholder="请输入类型名称" maxlength="50">
        ...
        <div class="content">
            <form id="newForm" method="post">
                <div class="content-item">
                    <label>*分属类型</label>
                    <!-- <input class="easyui-validatebox" type="text" placeholder="请输入分属类型" data-options="required:true" maxlength="50" /> -->
               		<select name="type" class="easyui-validatebox" data-options="required:true, prompt:'请选择分属类型'">
	                    <option value="1">厂站</option>
		            	<option value="2">设备</option>
		            	<option value="3">部件</option>
		            	<option value="4">车辆</option>
        ...
        <div class="content">
            <form id="editForm" method="post">
                ...
                <div class="content-item">
                    <label>*分属类型</label>
                    <!-- <input class="easyui-validatebox" type="text" placeholder="请输入分属类型" data-options="required:true" maxlength="50" /> -->
                    <select name="type" id="editType" class="easyui-validatebox" data-options="required:true, prompt:'请选择分属类型'">
	                    <option value="1">厂站</option>
		            	<option value="2">设备</option>
		            	<option value="3">部件</option>
		            	<option value="4">车辆</option>
    ...
    <script src="<%=basePath%>front/public/js/taskConfig.js"></script>
</body>
